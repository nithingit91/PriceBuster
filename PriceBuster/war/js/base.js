 ...
 * @type {string}
 */
google.devrel.samples.hello.CLIENT_ID = 'pricebuster691';
...
//  document.getElementById('getProduct').onclick = function() {
//   google.devrel.samples.hello.getProduct(
//    		inputSearch);
//  }

//  document.getElementById('listProduct').onclick = function() {
//    google.devrel.samples.hello.listProduct();
//  }

//  document.getElementById('updateProduct').onclick = function() {
//    google.devrel.samples.hello.updateProduct(
 //       document.getElementById('product').value,
 //       document.getElementById('count').value);
 // }

 // document.getElementById('authedProduct').onclick = function() {
//    google.devrel.samples.hello.authedProduct();
 // }
...
google.devrel.samples.hello.init = function(apiRoot) {
  ...
  gapi.client.load('pricebuster691', 'v1', callback, apiRoot);
